...
export class SearchComponent implements OnInit {
 ...
 date: Date = new Date();
  ...
  constructor(private matDialog: MatDialog,private snackBar: MatSnackBar,private noteService: NoteService,private labelService: LabelService,private dashBoard:DashboardComponent,private dataService:DataService) { }
  notes : any;
  ngOnInit() {
